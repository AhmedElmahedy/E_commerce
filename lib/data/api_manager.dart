...
import 'package:e_commerc/core/core/resources/constants_manager.dart';
...
class ApiManager {
  ...
  Future<Response> postData(String endPoint,
      {Map<String, dynamic>? queryParameters,Map<String, dynamic>? headers, Map<String, dynamic>? body}) {
