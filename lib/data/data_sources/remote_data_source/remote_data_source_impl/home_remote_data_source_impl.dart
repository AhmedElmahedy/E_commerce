...
class HomeRemoteDataSourceImpl implements HomeRemoteDataSource{
  ...
  @override
  Future<Either<Failures, CategoriesOrBrandsResponseDto>> getAllCategories()async {
    ...
    try {
      ...
      if (checkResult == ConnectivityResult.wifi ||
        ...
        var getAllCategoryResponse = CategoriesOrBrandsResponseDto.fromJson(response.data);

        if (response.statusCode! >= 200 && response.statusCode! < 300) {
          return Right(getAllCategoryResponse);
        } else {
          return Left(ServerError(errorMessage: getAllCategoryResponse.message!));
        }
      } else {
        // No internet
  ...
  Future<Either<Failures, CategoriesOrBrandsResponseEntity>> getAllBrands()async {
    ...
    try {
      ...
      if (checkResult == ConnectivityResult.wifi ||
        ...
        var getAllBrandsResponse = CategoriesOrBrandsResponseDto.fromJson(response.data);
