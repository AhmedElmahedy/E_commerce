...
class GetProductDto extends GetProductEntity{
  ...
  GetProductDto.fromJson(dynamic json) {
    ...
    category =
        json['category'] != null ? CategoriesOrBrandsResponseDto.fromJson(json['category']) : null;
    brand = json['brand'] != null ? CategoriesOrBrandsResponseDto.fromJson(json['brand']) : null;
